...
/** All three filters map 1:1 onto GET /api/v1/units' query params (search, departmentId, isActive). */
const UnitsFilterBar = ({
  ...
  const activeFilterCount = [search, departmentId, isActive].filter(Boolean).length;
