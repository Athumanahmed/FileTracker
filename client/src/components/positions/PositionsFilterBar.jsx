...
/**
 * All filters map 1:1 onto GET /api/v1/positions' query params (search,
 * departmentId, unitId, positionType, isActive). Unit options narrow to
 * the selected department automatically, same cascade as UsersFilterBar.
 */
const PositionsFilterBar = ({
  ...
  const activeFilterCount = [search, departmentId, unitId, positionType, isActive].filter(Boolean).length;
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <select value={positionType} onChange={(e) => onPositionTypeChange(e.target.value)} className={selectClassName}>
