...
/** All three filters map 1:1 onto GET /api/v1/roles' query params (search, isSystem, isActive). */
const RolesFilterBar = ({
  ...
  const activeFilterCount = [search, isSystem, isActive].filter(Boolean).length;
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
      ...
      <div className="flex flex-wrap gap-3">
        <select value={isSystem} onChange={(e) => onIsSystemChange(e.target.value)} className={selectClassName}>
