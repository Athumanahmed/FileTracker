...
/** Both filters map 1:1 onto GET /api/v1/departments' query params (search, isActive). */
const DepartmentsFilterBar = ({ search, onSearchChange, isActive, onIsActiveChange, onReset }) => {
...
export default DepartmentsFilterBar;
